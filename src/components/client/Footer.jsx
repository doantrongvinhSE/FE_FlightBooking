...
function Footer() {
  return (
    <footer class="w-full bg-white border-t-[1px]">
        ...
        <div class="grid grid-cols-12 gap-8 py-14 lg:grid-cols-8">
          ...
          <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
            ...
            <div class="flex flex-col items-center lg:items-start">
              <Input
                prefix={<IoMailOpenOutline  className="text-xl"/>}
                placeholder="Your email here.."
                className="mail-icon w-full h-12 border  border-gray-300 rounded-full  px-5 shadow-sm text-gray-800 mb-5 text-center placeholder:text-gray-400 focus:outline-none focus:border-gray-500"
              />
              {/* <input type="text" class=""  placeholder="Your email here.."/> */}
              <button
                type="submit"
                class="h-11 py-3 px-6 bg-green-600 transition-all duration-500 shadow-md rounded-full text-sm text-white font-semibold w-fit hover:bg-green-400"
              >
                Subscribe
              </button>
            </div>
        ...
        <div class="py-7 border-t border-gray-200">
          <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span class="text-sm text-gray-500 ">
              ©<a href=""> Airlines</a> 2024, All rights reserved.
            </span>
