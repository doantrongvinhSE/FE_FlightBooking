  ...
  return (
    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="grid grid-cols-12 gap-8 py-14 lg:grid-cols-8">
            ...
            <a href="/" className="text-2xl flex gap-3 items-center font-bold text-red-500">
            <SiTurkishairlines />
            Vietnam Airlines
          </a>
                <p class="py-8  text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in more than 100 countries & 5 million customers. Follow us on social media.</p>
                <div class="flex mt-4 space-x-3 justify-center lg:justify-start sm:mt-0 ">
                    ...
                    <a href="javascript:;"  class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
                        <svg class="w-[1rem] h-[1rem] text-white" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.04111 7.81204L7.41156 5.46043H5.1296V3.93188C5.1296 3.28886 5.44818 2.66054 6.46692 2.66054H7.51899V0.657999C6.90631 0.560385 6.28723 0.507577 5.66675 0.5C3.78857 0.5 2.56239 1.62804 2.56239 3.66733V5.46043H0.480469V7.81204H2.56239V13.5H5.1296V7.81204H7.04111Z" fill="currentColor"></path>
                            </svg>
            ...
            <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
                ...
                <ul class="text-gray-600 transition-all duration-500  ">
                    ...
                    <li class="sm:mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Features</a></li>
                </ul>
            </div>
            <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                ...
                <div class="flex flex-col items-center lg:items-start">
                    ...
                    <button type="submit" class="h-11 py-3 px-6 bg-red-600 transition-all duration-500 shadow-md rounded-full text-sm text-white font-semibold w-fit hover:bg-red-400">Subscribe</button>
                </div>
            </div>
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-500 ">©<a href=""> Airlines</a> 2024, All rights reserved.</span>
