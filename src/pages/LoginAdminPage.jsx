  ...
  return (
    <>
      {/*
          ...
          ```
        */}
      <div className="bg-[url('https://assets.enterprisenetworkingplanet.com/uploads/2023/08/enp-intrusion-detection-prevention-systems.png')] bg-cover bg-center flex h-screen flex-1 flex-col justify-center lg:px-8">
          ...
          <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            <form action="#" method="POST" className="space-y-6">
              ...
              <div className="flex justify-between">
                <Checkbox className="font-medium text-gray-500">
                  Remember me?
                </Checkbox>
